...
const aulas = {
  ...
  document.getElementById('titulo-bemvindo').textContent = `Bem-vindo(a), ${user}!`;
...
function confirmarPresenca() {
  ...
  if (todosMarcados) {
    ...
    alert('Por favor, justifique todas as ausências antes de confirmar a lista.');
  }
}
...
function enviarRecado() {
  ...
  if (mensagem) {
    ...
    alert('Digite uma mensagem para enviar o recado.');
  }
}
...
function salvarRelatorio() {
  ...
  if (texto) {
    ...
    alert('Digite o conteúdo do relatório antes de salvar.');
  }
}
